    ...
    lanes:
      ...
      - name: "pedido"
        ...
        agent_behavior:
          ...
          - "Use the tool workitem_move (orqen MCP Server) para mover o item da lane pedido para gerando"
          - "Finalize a execução"
        critical_rules:
      ...
      - name: "gerando"
        ...
        agent_behavior:
          ...
          - "Use the tool workitem_move (orqen MCP Server) para mover o item da lane gerando para build"
          - "Finalize a execução"
        critical_rules:
      ...
      - name: "build"
        ...
        agent_behavior:
          ...
          - "Use the tool workitem_move (orqen MCP Server) para mover para deploy (se sucesso) ou falha (se erro)"
          - "Finalize a execução"
        critical_rules:
      ...
      - name: "deploy"
        ...
        agent_behavior:
          ...
          - "Use the tool workitem_move (orqen MCP Server) para mover para deploy_realizado"
          - "Finalize a execução"
        critical_rules:
