...
func NewChatMCPServer(proj *engine.Project, chatStore *memory.ChatStore, sessionMgr *memory.SessionManager) http.Handler {
...
func createChatServer(proj *engine.Project, chatStore *memory.ChatStore, sessionMgr *memory.SessionManager) *mcp.Server {
