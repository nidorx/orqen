...
```
$ go test ./...
ok  	github.com/nidorx/orqen/pkg/memory/cmd/engram	2.226s
ok  	github.com/nidorx/orqen/pkg/memory/cloud	(cached)
ok  	github.com/nidorx/orqen/pkg/memory/cloud/auth	(cached)
ok  	github.com/nidorx/orqen/pkg/memory/cloud/autosync	(cached)
ok  	github.com/nidorx/orqen/pkg/memory/cloud/chunkcodec	(cached)
ok  	github.com/nidorx/orqen/pkg/memory/cloud/cloudserver	(cached)
ok  	github.com/nidorx/orqen/pkg/memory/cloud/cloudstore	(cached)
?   	github.com/nidorx/orqen/pkg/memory/cloud/constants	[no test files]
ok  	github.com/nidorx/orqen/pkg/memory/cloud/dashboard	(cached)
ok  	github.com/nidorx/orqen/pkg/memory/cloud/remote	(cached)
ok  	github.com/nidorx/orqen/pkg/memory/mcp	2.502s
ok  	github.com/nidorx/orqen/pkg/memory/obsidian	(cached)
ok  	github.com/nidorx/orqen/pkg/memory/project	(cached)
ok  	github.com/nidorx/orqen/pkg/memory/server	(cached)
ok  	github.com/nidorx/orqen/pkg/memory/setup	(cached)
ok  	github.com/nidorx/orqen/pkg/memory/store	1.131s
ok  	github.com/nidorx/orqen/pkg/memory/sync	(cached)
ok  	github.com/nidorx/orqen/pkg/memory/tui	(cached)
ok  	github.com/nidorx/orqen/pkg/memory/version	(cached)
```
...
PASS
ok  	github.com/nidorx/orqen/pkg/memory/store	0.015s
...
PASS
ok  	github.com/nidorx/orqen/pkg/memory/mcp	0.039s
```
