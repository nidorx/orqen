---
name: create-adr
description: 'Use this command when you need to document an architectural decision made during a task.'
allowed-tools: Bash
---
...
Inspired by [adr-tools](https://github.com/npryce/adr-tools) (Nygard format).

## When to use this

Create an ADR when your work involves any of these:
- Choosing a storage strategy (filesystem vs database)
