...
- The agent command is invoked as a subprocess. The agent receives synthesized prompts and interacts with the project via MCP tools (`workitem`, `workitem_create`, `workitem_move`, etc.).
